...
public class MealDirectionFragment extends Fragment {
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_ITEM_ID = "item_id";

    private Meal mItem;

    public MealDirectionFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_meal_direction, container, false);

        // Show the meal content
        if (mItem != null)
        {
            List<BasicItem> list = new ArrayList<BasicItem>();
            List<String> arrayList = mItem.Instruction();
